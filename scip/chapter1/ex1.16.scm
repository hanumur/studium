...
;; (Hint: Using the observation that (b^n/2)² = (b²)n/2, keep, along with the exponent n
;; and the base b, an additional state variable a, and define the state transformation
;; in such a way that the product a b^n is unchanged from state to state. At the beginning
;; of the process a is taken to be 1, and the answer is given by the value of a at the end
;; of the process. In general, the technique of defining an invariant quantity that remains
